...
if(isset($GLOBALS['LetoDMS_HOOKS']['initDB'])) {
	foreach($GLOBALS['LetoDMS_HOOKS']['initDB'] as $hookObj) {
...
if(isset($GLOBALS['LetoDMS_HOOKS']['initDMS'])) {
	foreach($GLOBALS['LetoDMS_HOOKS']['initDMS'] as $hookObj) {
